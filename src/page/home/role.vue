  ...
  <div class="w-100 order flex-col h-100" style="overflow-x:hidden;">
    <el-row :gutter="20">
      <el-col :span="6">
        ...
        <div class="dy">打印模式</div>
        <div class="dy2">
          <el-radio v-model="radio" :label="1" @change="Dayin">工时项目综合</el-radio>
        </div>
        <div class="dy2">
          <el-radio v-model="radio" :label="2" @change="Dayin">工时项目分开</el-radio>
        </div>
      </el-col>
      <el-col :span="17">
        <el-card class="box-card">
          ...
          <el-checkbox-group v-model="list">
            <div v-for="item in authGroupList" :key="item.authGroup" style="padding-top:10px;">
              ...
              <div class="sel">
                <el-checkbox
                  :label="v.authItem"
                  v-for="v in item.authItemList"
                  :key="v.authItem"
                >{{v.authItemName}}</el-checkbox>
              </div>
            </div>
          </el-checkbox-group>
...
export default {
  ...
  methods: {
    Dayin(e) {
      console.log(e);
    //   localStorage.setItem("dayin", e);
    let data ={
        printType: e
    }
       updatePrintType(data).then(res => {
