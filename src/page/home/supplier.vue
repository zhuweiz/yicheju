  ...
  <div class="w-100 order flex-col">
        ...
        <el-form :inline="true" class="demo-form-inline">
          <el-col>
            <el-form-item label="供应商名称" class="m-b-0">
              <el-input v-model="search.supplierName" placeholder style="width:100%;"></el-input>
            </el-form-item>
    ...
    <div style="width:100%;padding-top:15px;" class="orderTable" id="printBox">
      <el-table :data="tableData" :max-height="maxHeight" style="width: 100%">
        ...
        <el-table-column prop="supplierName" label="配件商名称"></el-table-column>
    ...
    <el-dialog title="添加我的配件商" :visible.sync="addStatus" width="70%" :modal="false" center>
      <div>
        <el-input v-model="search.supplierName" placeholder style="width:300px;"></el-input>
          <el-button type="success" icon="el-icon-search" @click="init2()">查找</el-button>
      </div>
