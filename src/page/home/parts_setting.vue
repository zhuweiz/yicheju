<template>
  <div class="w-100 order flex-col">
    ...
    <el-dialog title="修改配件" :visible.sync="editStatus" center width="30%" :modal="false">
      <el-form :model="editPartsForm">
        <el-form-item label="名称" label-width="100px">
          <el-input v-model="editPartsForm.partName"></el-input>
        </el-form-item>
...
<script>
import { getPartPercentage, queryPartPercentageList, setPartPercentage, queryPercentageClass} from "../../request/api.js"
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryPartPercentageList(data).then(res => {
        this.tableData = res.data.data
      })
    },
    editFormSubmit() {
			this.editPartsForm.percentClassId = this.editPartsForm.classId.pop()
			const data = {
				partId: this.editPartsForm.partId,
				name: this.editPartsForm.partName,
				percentClassId: this.editPartsForm.classId.pop(),
				price: this.editPartsForm.partPrice
			}
      setPartPercentage(this.editPartsForm).then(res => {
